...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--preprocess', type=str, default='scale_short_and_crop', help='scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | scale_short_and_crop | none]')
